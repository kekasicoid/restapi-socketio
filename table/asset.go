...
type Asset struct {
	...
	Price       int    `json:"price" gorm:"column:description"`
	Brand       string `json:"brand" gorm:"column:description;size:255"`
	Category    string `json:"category" gorm:"column:description;size:255"`
